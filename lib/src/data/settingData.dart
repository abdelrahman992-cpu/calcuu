...
class SettingData with ChangeNotifier {
  static late int _fixedNum; //存储小数位值
  static late String language; //当前设备语言
  static late int nowPage; //当前页面级数

  //非一级页面时存储用于pop的context （阻止ios主题时系统导航栏返回键直接退出应用
  static late BuildContext pageContext;
  late String theme; //应用主题
