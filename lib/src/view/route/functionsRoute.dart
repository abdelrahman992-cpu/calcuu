...
import 'package:calculator/src/view/route/equationRoute.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: TabBar(
            ...
            tabs: <Widget>[
              Tab(
                child: Text(XiaomingLocalizations.of(context).equations),
              ),
              Tab(
                  child:
                      Text(XiaomingLocalizations.of(context).definiteIntegral))
            ],
          ),
        ),
        body: TabBarView(
        ...
        child: Card(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              CupertinoButton(
                  onPressed: onPressed, child: Icon(CupertinoIcons.forward)),
            ],
          ),
        ),
      );
